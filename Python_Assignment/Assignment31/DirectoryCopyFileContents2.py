...
def DirectoryCopyContentsWithExtension(SourceDir,DestinationDir,Extension):
...
def main():
    ...
    if(len(sys.argv) == 2):
        if(sys.argv[1] == "--h" or sys.argv[1] == "--H"):
            ...
            print("Extension : Give the exiension of file that you want to search")
    ...
    #python program1.py Demo Hello
        ...
        DirectoryCopyContentsWithExtension(DirName1,DirName2,Extension)
